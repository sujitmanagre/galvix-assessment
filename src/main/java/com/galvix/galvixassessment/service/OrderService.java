...
public class OrderService {
	...
	public List<OrderResponse> orderDetails(MultipartFile file, ResponseType responseType) throws IOException {
		try {
			List<Order> orders = requestParserService.readJsonlFile(file);
